...
description: Profundiza en módulos de AngularJS, bootstrapping manual, inyección de dependencias y patrones de organización para proyectos grandes.
---
...
- Evita watchers innecesarios; usa eventos (`